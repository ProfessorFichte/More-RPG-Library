...
public class FriendlyLightningEntityRenderer extends EntityRenderer<FriendlyLightningEntity> {
    ...
    public void render(FriendlyLightningEntity entity, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light) {
        ...
        for (int l = 0; l < 4; ++l) {
            Random random2 = Random.create(entity.seed);
    ...
    private static void drawBranch(
        ...
        buffer.vertex(matrix, x1 + (shiftEast1 ? offset1 : -offset1), (float)(y * 16), z1 + (shiftSouth1 ? offset1 : -offset1))
        ...
        buffer.vertex(matrix, x2 + (shiftEast2 ? offset2 : -offset2), (float)((y + 1) * 16), z2 + (shiftSouth2 ? offset2 : -offset2))
            .color(red, green, blue, 0.3F);
        buffer.vertex(matrix, x1 + (shiftEast2 ? offset1 : -offset1), (float)(y * 16), z1 + (shiftSouth2 ? offset1 : -offset1))
            .color(red, green, blue, 0.3F);
    }
