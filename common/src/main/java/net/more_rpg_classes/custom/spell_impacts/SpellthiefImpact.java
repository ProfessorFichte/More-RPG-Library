            ...
            Runnable release = () -> {
                ...
                switch (delivery) {
                    ...
                    case BEAM -> {
                        ...
                        SpellImpacts.performImpacts(caster.getWorld(), caster, target, caster, spellEntry,
                                stolenSpell.impacts, ctx, false, null);
                        ...
                        if (caster.getWorld() instanceof ServerWorld beamWorld) {
                            for (Entity candidate : beamWorld.getOtherEntities(caster,
                                ...
                                SpellImpacts.performImpacts(caster.getWorld(), caster, candidate, caster, spellEntry,
                                        stolenSpell.impacts, ctx, false, null);
                            }
                        }
                    }
